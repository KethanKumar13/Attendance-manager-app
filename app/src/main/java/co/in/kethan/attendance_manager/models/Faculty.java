package co.in.kethan.attendance_manager.models;
...
public class Faculty {
    ...
    private String faculty_mobile_number;
    ...
    public String getFaculty_mobile_number() {
        return faculty_mobile_number;
    }

    public void setFaculty_mobile_number(String faculty_mobile_number) {
        this.faculty_mobile_number = faculty_mobile_number;
    }
