...
import co.in.kethan.attendance_manager.controllers.DBHandler;
import co.in.kethan.attendance_manager.models.Attendance;
import co.in.kethan.attendance_manager.models.AttendanceSession;
import co.in.kethan.attendance_manager.models.Faculty;
import co.in.kethan.attendance_manager.models.Student;

public class AddAttendanceSessionActivity extends AppCompatActivity {

    private final String[] branchString = new String[]{"AIML","CSE", "ME", "EEE", "CIVIL", "ECE"};
    private final String[] SemString = new String[]{"1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th"};
    private final String[] subjectFinal = new String[]{"ML", "DIP", "JMA", "FDS", "ITS"};
